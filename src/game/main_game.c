...
void re_start(void){KillAll();stopped=0;main_start();}
...
{
    /* MAIN.S ProtectVoices(7), InitMJP and fixed 320x240 setup. */
    ProtectV(7);
    fevent(0x494d4a50u,320,240);
